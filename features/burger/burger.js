...
Given('I request {string} {string}', function (string, string2) {
...
/////////7//////
When('I request {string} {string}', function (string, string2) {
    // Write code here that turns the phrase above into concrete actions
    return 'pending';
});
...
Then('the response status should be {int}', function (int) {
    // Then('the response status should be {float}', function (float) {
    // Write code here that turns the phrase above into concrete actions
    return 'pending';
});

Then('I should receive a an array with {int} elements', function (int) {
    // Then('I should receive a an array with {float} elements', function (float) {
    // Write code here that turns the phrase above into concrete actions
    return 'pending';
});
...
////////9//////
When('I request {string} {string} with a payload', function (string, string2, dataTable) {
    // Write code here that turns the phrase above into concrete actions
    return 'pending';
});
